...
def locusfeature_get(locus):  # noqa: E501
    ...
    try:
        ...
        return Error("failed to load the feature of given locus", log=log_contents.split("\n")), 404
    ...
    if not feats:
        log_contents = log_capture_string.getvalue()
        return Error("no feature associated with the given locus", log=log_contents.split("\n")), 404
